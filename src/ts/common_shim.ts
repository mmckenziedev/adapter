...
export function shimRTCIceCandidate(window: any) {
  ...
  window.RTCIceCandidate = (args: any) => {
  ...
  utils.wrapPeerConnectionEvent(window, "icecandidate", (e: any) => {
    if (e.candidate) {
...
export function shimCreateObjectURL(window) {
  ...
  URL.createObjectURL = (stream: MediaStream) => {
